...
dados_despesas1 = pd.DataFrame(dados_despesas.get_all_records())

# for index, row in dados_despesas.iterrows():
#   processo_despesa = row['PROCESSOS']
#   empenho = row['EMPENHO']
#   programa_trabalho = row['PROGRAMA DE TRABALHO']
#   codigo_despesa = row['CÓDIGO DE DESPESA']
#   fonte = row['FONTE']
#   despesas_filtradas = dados_despesas.('PROCESSOS')
#   print(despesas_filtradas)

processo = '014/003981/2024'


dados_despesas_filtradas = dados_despesas1[dados_despesas1['PROCESSOS'] == processo]
empenhos_processo = dados_despesas_filtradas[['EMPENHO', 'PROGRAMA DE TRABALHO', 'CÓDIGO DE DESPESA', 'FONTE' ]]
